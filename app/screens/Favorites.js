...
export default function Favorites(props) {
  ...
  return (
    <View style={styles.viewBody}>
      {navigation.addListener("focus", () => setReloadRestaurants(true))}
      {restaurants ? (
        <FlatList
          data={restaurants}
      ...
      <Loading
        text="Deleting restaurant from favorites..."
...
function Restaurant(props) {
  ...
  const confirmRemoveFavorite = () => {
    Alert.alert(
      ...
      "Are you sure delete this restaurant from favorites?",
      [
        {
          text: "Cancel",
          style: "cancel",
        ...
        response.forEach((doc) => {
          ...
          db.collection("favorites")
            ...
            .then(() => {
              ...
              toastRef.current.show("Restaurant deleted successfully");
            })
            .catch((error) => {
              console.log(error);
              setIsVisibleLoading(false);
              toastRef.current.show("Error deleting restaurant, try later");
            });
        });
      });
  };
...
function NotFountRestaurants(props) {
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      ...
      <Text style={{ fontSize: 20, fontWeight: "bold" }}>
        You haven't restaurant in favorites
      </Text>
    </View>
  );
}
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      ...
      <Text style={{ fontSize: 20, fontWeight: "bold", textAlign: "center" }}>
        You need are logged to view this section
      </Text>
      <Button
        title="Go to login"
